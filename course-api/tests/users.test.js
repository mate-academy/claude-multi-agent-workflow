...
test('GET /users/:id returns 200 with the user object for an existing user', async () => {
...
test('POST /users returns 400 when the body is missing required fields', async () => {
...
test('PUT /users/:id returns 400 when the body has no valid fields for an existing user', async () => {
